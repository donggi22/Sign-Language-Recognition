...
def app():
    ...
    try:
        ...
        st.error(f"GIF 파일을 찾을 수 없습니다: {gif_paths[2]}")
    
    st.markdown(f"<h2 style='text-align: center; color: #333;'>{destination}(으)로 가시려면 <br>경복궁역 5번 출구로 나가세요.<b2>", unsafe_allow_html=True)
